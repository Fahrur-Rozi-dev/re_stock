  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="p-5 bg-gray-800 text-white rounded-lg shadow-md mb-6">
        ...
        <p>Rp {dashboardData?.totalValue?.toLocaleString("id-ID") || 0}</p>
        <p>📊 Unrealized Profit: Rp {dashboardData?.unrealizedProfit?.toLocaleString("id-ID") || 0}</p>
        <p>💵 Realized Profit: Rp {dashboardData?.realizedProfit?.toLocaleString("id-ID") || 0}</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {dashboardData.lowStockProducts.length > 0 && (
            <div className="p-5 bg-yellow-500 text-white rounded-lg shadow-md col-span-1 md:col-span-2">
              <h2 className="text-lg font-semibold">Stok Hampir Habis ⚠️</h2>
          ...
          {dashboardData.highStockProduct && (
            <div className="p-5 bg-purple-500 text-white rounded-lg shadow-md col-span-1 md:col-span-2">
              <h2 className="text-lg font-bold"> Produk dengan Stok Terbanyak 🔥</h2>
